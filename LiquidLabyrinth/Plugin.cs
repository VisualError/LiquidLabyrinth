...
internal class Plugin : BaseUnityPlugin
{
    ...
    List<string> scientificNames = [
        ...
        "Einstein", "Dark Matter",
        "Dark Energy", "Quantum Entanglement", "Higgs Boson",
        "Gravitational Wave", "Wormhole", "Tachyon", "Singularity", "Event Horizon",
        "Neutrino", "Muon", "Lepton", "Quark", "Gluon",
        "Atom", "Electron Shell", "Proton", "Electron", "Nuclear Fusion",
        "Nuclear Fission", "Atomic Bond", "Isotope", "Radioactive Decay", "Alpha Particle",
        "Beta Particle", "Gamma Ray", "Microwave", "Radio Wave", "X-Ray",
        "Ultraviolet Ray", "Visible Light", "Infrared Ray",
        "Cosmic Ray", "Hubble Constant",
        "Big Crunch", "Heat Death", "Black Hole", "Quasar",
